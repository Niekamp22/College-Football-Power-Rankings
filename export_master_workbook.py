...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--split-summary", type=Path, default=DEFAULT_SPLIT_SUMMARY_PATH)
    parser.add_argument("--team-bias", type=Path, default=DEFAULT_TEAM_BIAS_PATH)
    parser.add_argument("--conference-summary", type=Path, default=DEFAULT_CONFERENCE_SUMMARY_PATH)
...
def main() -> None:
    ...
    split_summary = load_csv(args.split_summary)
    team_bias = load_csv(args.team_bias)
    conference_summary = load_csv(args.conference_summary)
    ...
    write_sheet(workbook, "SplitSummary", split_summary)
    write_sheet(workbook, "TeamBias", team_bias)
    write_sheet(workbook, "ConferenceSummary", conference_summary)
